...
// Separate component to use hooks properly inside map
function CardBudgetItem({ 
  cardId, 
  cardName, 
  onSetBudget 
}: { 
  cardId: string; 
  cardName: string; 
  onSetBudget: (cardId: string) => void;
}) {
  const progress = useAtomValue(getCardBudgetProgressAtom(cardId));
